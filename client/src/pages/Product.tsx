...
export default function Product() {
  ...
  return (
    ...
    <div className="relative max-w-full">
      ...
      <Navbar />
      <MainLayout>
        {product?<div className="flex flex-col-reverse gap-4 sm:flex-row">
          ...
          <div className="flex-1 text-black">
            ...
            <div>
              ...
              <div className="flex flex-col gap-4 pt-4 lg:flex-row">
                ...
                <button className="flex h-[64px] w-full items-center justify-center gap-2 bg-black text-white transition duration-300 hover:scale-105" onClick={() => {
                    addCart({
                      ...product,
                      price: product?.price,
                      quantity: 1,
